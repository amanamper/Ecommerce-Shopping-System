...
public class MainWebsiteApplication {
    ...
    public static void main(String[] args) {
        Product p = new Product("Shoe", 1L, "Footware Collection", 5.99);
        website.addProductToCatalog(p);
        p = new Product("Book", 2L, "A4 size book", 10.99);
        website.addProductToCatalog(p);
        p = new Product("Bags", 3L, "Bag Collection", 6.99);
        website.addProductToCatalog(p);
        p = new Product("Laptop", 4L, "Laptop Collection", 15.99);
        website.addProductToCatalog(p);
        p = new Product("Chair", 5L, "4 leg Chair ", 79.99);
        website.addProductToCatalog(p);
    ...
    private static void doLogin() {
        ...
        if (choice == 2) {
            ...
            if (loggedInCustomer.isPresent())
                ...
                System.out.println("Customer with username/password combination doesn't exists. Please signup");
        }
        ...
        while (choice != 4) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    System.out.println(loggedInCustomer.getShoppingCart().getProductList());
                    System.out.println("Total amount of $" + loggedInCustomer.getShoppingCart().getTotalPrice());
